        ...
        <div className="bg-cover bg-center h-screen flex flex-col justify-center items-center" style={{ backgroundImage: "url('/planete.jpg')" }}>
            ...
            <div className="flex flex-col justify-center items-center">
                ...
                <div className="bg-gray-200 w-64 mx-2 rounded-lg shadow-md p-4 mb-4">
                    ...
                    <p>Notre objectit est de faire de GeoGuesr un espace sur, equitable et amusant pour vous permettre de jouer ou de passer du temps avec vos amis. Nos Regles Communautaires s'appliquent à tous les utilisateurs de GeoGuesr.</p>
                </div>
